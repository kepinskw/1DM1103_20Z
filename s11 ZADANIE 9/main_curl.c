...
int info(char *token) {
    ...
    make_request("http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/info/qwerty_14" ) ;
...
int move(char *token) {
    ...
    make_request( "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/move/qwerty_14 ");


    return 0;
}
int rotateleft(char *token) {

    make_request("http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/rotate/qwerty_14/left");


    return 0;
}
int rotateright(char *token) {

    make_request("http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/rotate/qwerty_14/right");
